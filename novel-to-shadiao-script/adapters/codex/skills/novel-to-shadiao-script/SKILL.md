...
Use this skill to adapt fiction into 沙雕动画小助手 production scripts.
...
When the project source exists, prefer the full workflow at `skills/novel-to-shadiao-script/SKILL.md`.
